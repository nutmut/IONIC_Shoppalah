...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://shopalah.firebaseio.com/"),
    refCart = new Firebase("https://shopalah.firebaseio.com/cart"),
    refUser = new Firebase("https://shopalah.firebaseio.com/users"),
    refCategory = new Firebase("https://shopalah.firebaseio.com/category"),
    refOrder = new Firebase("https://shopalah.firebaseio.com/orders"),
    refFeatured = new Firebase("https://shopalah.firebaseio.com/featured"),
    refMenu = new Firebase("https://shopalah.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
